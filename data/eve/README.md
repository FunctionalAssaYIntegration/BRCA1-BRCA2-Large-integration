...
This directory contains lightweight instructions for recreating the large EVE
files used by the BRCA1/BRCA2 integration analysis. The downloaded archives and
generated workbook are intentionally not committed to GitHub.
...
By default it verifies that the downloaded EVE archives match the SHA-256
hashes used for the reported analysis:
...
After `data/eve/EVE_BRCA12_scores.xlsx` exists, run the repository pipeline:
...
Sup Tables 18 and 19 use the EVE workbook through `src/sup_table_18_19.py`.
