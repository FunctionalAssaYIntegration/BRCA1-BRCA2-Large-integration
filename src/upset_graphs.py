"""Superseded exploratory script.

The publication UpSet diagram (Supplementary Figure 3) is now generated by
``supp_fig3``, which derives the enrichment/depletion
sets from the pipeline workbook instead of the hard-coded table below. The
table here reflects an earlier version of the analysis and is retained only for
provenance; do not use it to regenerate reported figures.
"""
